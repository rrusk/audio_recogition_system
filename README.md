...
1. Run `$make fingerprint-songs-filter-duplicates` to generate a database with distinct songs

# Original Readme from https://github.com/baliksjosay/audio_recogition_system
